...
<body>
     ...
     <div class="containers">
          <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-2 pl-4  border-bottom">
               <a href="{{url('/employeeDashbord/profile')}}" class="d-flex col-md-2 align-items-center text-dark text-decoration-none">
                    <h3>SSLPL</h3>
               </a>

               <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
                    <li><a href="{{'/employeeDashbord/profile'}}" class="nav-link px-2 link-secondary">Profile</a></li>
                    <li><a href="{{'/employeeDashbord/applyleave'}}" class="nav-link px-2 link-secondary">ApplyLeave</a></li>
               </ul>
